  ...
  <div class="page_">
    <a-form :form="form" @submit="handleSubmit">
      ...
      <a-row>
        ...
        <a-col :span="12">
          <a-form-item v-bind="formItemLayout" label="姓名">
            <a-input v-decorator="['name_receiptor']" placeholder="请输入姓名">
            </a-input>
          </a-form-item>
        </a-col>
        <a-col :span="12">
        ...
        <a-col :span="12">
          <a-form-item v-bind="formItemLayout" label="证件有效起期">
            <a-date-picker
              v-decorator="['idStartDate_receiptor']"
              placeholder="请选择证件有效起期"
            >
            </a-date-picker>
          </a-form-item>
        ...
        <a-col :span="12">
          <a-form-item v-bind="formItemLayout" label="证件有效止期">
            <a-date-picker
              v-decorator="['idEndDate_receiptor']"
              placeholder="请选择证件有效止期"
            >
            </a-date-picker>
          </a-form-item>
